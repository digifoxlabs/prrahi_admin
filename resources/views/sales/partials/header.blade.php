      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
              <img src="{{ auth('sales')->user()->profile_photo ? asset('storage/' . auth('sales')->user()->profile_photo) : asset('images/user/user-01.jpg') }}" alt="user" />
        ...
        >
          <div>
            ...
            >
              {{ strtoupper(auth('sales')->user()->name) }}
            </span>
            <span
