                    ...
                    <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
                            ...
                            <div class="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
                                 ...
                                 <a href="{{ route('sales.distributors.edit', $distributor->id) }}"
                ...
                uploadCroppedImage() {
                    if (this.cropper) {
                        this.cropper.getCroppedCanvas().toBlob((blob) => {
                            ...
                            fetch('{{ route('sales.distributors.updateProfileImage', $distributor->id) }}', {
                                method: 'POST',
                                body: formData,
                            })
        ...
        function updatePasswordComponent() {
            return {
                ...
                async submitPassword() {
                    ...
                    try {
                        const res = await fetch("{{ route('sales.distributors.updatePassword') }}", {
                            method: 'POST',
                            headers: {
