...
<div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900">My Distributors</h1>
                <p class="text-gray-600 mt-2">Manage all Distributors</p>
            </div>
            <a href="{{ route('sales.distributors.create') }}"
                        ...
                        <td class="px-4 py-3 text-right" x-data="{
                                    ...
                                    window.addEventListener('scroll', onScroll, true);
                                                                ...
                                                                <div class="inline-block text-left">
                                                                    <button x-ref="actionsBtn" @click="openDropdown()" type="button" class="inline-flex items-center gap-1 px-3 py-2 text-sm font-medium
                            ...
                            <div x-cloak x-show="open" x-transition @click.away="open = false" :style="dropdownStyle"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                    ...
                                    <li>
                                        <a href="{{ route('sales.distributors.show', $distributor) }}"
                                    ...
                                    <li>
                                        <a href="{{ route('sales.distributors.edit', $distributor) }}"
        ...
        return {
            ...
            updateQuery() {
                ...
                this.debounceTimeout = setTimeout(() => {
                    const base = '{{ route('sales.distributors.index') }}';
