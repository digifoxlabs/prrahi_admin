...
<section class="relative items-center hidden w-full h-full
  ...
  <div class="flex items-center justify-center z-1">
    ...
    <div class="absolute right-0 top-0 -z-1 w-full max-w-[300px] xl:max-w-[500px] opacity-80 pointer-events-none select-none">
      <img src="{{ asset('images/shape/sales-grid-top.svg') }}" alt="sales-grid-top" loading="lazy" decoding="async">
    </div>

    <!-- Bottom shape -->
    <div class="absolute bottom-0 left-0 -z-1 w-full max-w-[300px] xl:max-w-[500px] opacity-80 pointer-events-none select-none">
      <img src="{{ asset('images/shape/sales-grid-bottom.svg') }}" alt="sales-grid-bottom" loading="lazy" decoding="async">
    </div>
