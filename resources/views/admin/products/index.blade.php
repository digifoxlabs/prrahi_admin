    ...
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
        ...
        <div
            ...
            {{-- <div class="mx-auto w-full max-w-8xl">
                ...
                <div class="p-6" x-data="productTableComponent()"> --}}
                        ...
                        <table id="productsTable"
                            ...
                            <thead class="bg-gray-10">
                                <tr class="dark:text-black/90">
                                    ...
                                    <th class="px-2 py-2 border w-28">Dozen/Case</th>
                                    <th class="px-2 py-2 border w-28">MRP/Unit</th>
                                    <th class="px-2 py-2 border w-28">PTR/Dozen</th>
                                    <th class="px-2 py-2 border w-28">PTD/Dozen</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        {{-- Product Code --}}
                                        <td class="px-2 py-2 border">{{ $product->code }}</td>

                                        {{-- Category / Sub Category --}}
                                        <td class="px-2 py-2 border">
                                            {{ $product->type == 'variant'
                                                ? ($product->parent->category->name ?? '') . ' / ' . ($product->parent->subCategory->name ?? '-')
                                        ...
                                        {{-- Dozen per Case --}}
                                        <td class="px-2 py-2 border text-center">{{ $product->dozen_per_case }}</td>
