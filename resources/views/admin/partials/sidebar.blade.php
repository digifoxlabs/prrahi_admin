  ...
  >
    ...
    <nav x-data="{selected: $persist('Dashboard')}">
         ...
         <li>
          ...
          <li>
            <a
              ...
              @click="selected = (selected === 'Retail-Orders' ? '':'Retail-Orders')"   
              class="menu-item group"
              :class=" (selected === 'Retail-Orders') || (page === 'retail-orders') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'Retail-Orders') || (page === 'retail-orders') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09L9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09z"
                fill="" />
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456L18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456z"
                fill="" />
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M16.5 18.75l.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423L16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423z"
                fill="" />
              </svg>
          ...
          <li>
            <a
              href="{{ route('admin.sales-type.index')}}"
               @click="selected = (selected === 'Sales-Type' ? '':'Sales-Type')" 
              class="menu-item group"
              :class="(selected === 'Sales-Type') ||  (page === 'sales-type') ? 'menu-item-active' : 'menu-item-inactive'">

          <svg 
              :class="(selected === 'Sales-Type') || (page === 'sales-type') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
      ...
      <!-- Menu Item Profile -->
          <li>
            <a
              href="{{ route('api.doc')}}" target="_"
               @click="selected = (selected === 'API' ? '':'API')" 
              class="menu-item group"
              :class="(selected === 'API') || (page === 'api') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'API') || (page === 'api') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
