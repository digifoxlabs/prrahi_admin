      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
              <img src="{{ auth('admin')->user()->profile_image ? asset('storage/' . auth('admin')->user()->profile_image) : asset('images/user/user-01.jpg') }}"
                            alt="user" />
        ...
        >
          <div>
            ...
            >
              {{ strtoupper(auth('admin')->user()->fname.' '.auth('admin')->user()->lname) }}
            </span>
            <span
