...
<div x-data="posOrder()" class="grid grid-cols-12 gap-4">
    ...
    <form method="POST"
        ...
        <div class="grid grid-cols-4 gap-3 mb-4">
            ...
            <select name="distributor_id" required class="border rounded-lg p-2 text-sm">
...
function posOrder(){
    return {
        ...
        addProduct(product){
            ...
            if(item){
                ...
                this.cart.push({
                    ...
                    discount: product.distributor_discount_percent ?? 0,
        ...
        recalculate(){
            ...
            if(decimal < 0.5){
                this.roundOff = -decimal;
            } else {
                this.roundOff = (1 - decimal);
            }
