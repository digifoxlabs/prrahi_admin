                        ...
                        <div class="mb-3">
                            ...
                            <template x-if="product.type === 'simple'">
                                <button @click="addProduct(product); showProductPopup = false;"
                                    ...
                                    <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center font-bold text-lg">P</div>
                                    <div class="text-left">
                            ...
                            <template x-if="product.type === 'variable'">
                                <div class="border rounded-lg p-3 bg-gray-50">
                                    <p class="font-semibold text-sm mb-2" x-text="product.name"></p>
                                    <p class="text-sm mb-1" x-text="product.category.name"></p> 
                                    <template x-for="variant in product.variants" :key="variant.id">
                                        <button @click="addProduct(variant); showProductPopup = false;"
                                            class="block w-full text-left px-3 py-2 rounded hover:bg-indigo-100 transition-colors text-sm">
                                            →
...
@push('scripts')
    ...
    function posOrder(){
        return {
            ...
            search: '',
            cart: [],
            showProductPopup: false, // New property for mobile popup
