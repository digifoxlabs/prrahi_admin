            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('images/user/user-05.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
              <img src="{{ auth('distributor')->user()->profile_photo ? asset('storage/' . auth('distributor')->user()->profile_photo) : asset('images/user/user-01.jpg') }}" alt="user" />


          </span>

          <span class="text-theme-sm mr-1 block font-medium"> User </span>
        ...
        >
          <div>
            ...
            >
              {{ strtoupper(auth('distributor')->user()->firm_name) }}
            </span>
            <span
              class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400"
            >
              {{auth('distributor')->user()->email}}
            </span>
          </div>
        ...
        <div id="logout-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30" style="display: none;">
            <!-- Modal Backdrop (clicks ignored here) -->
            <div class="absolute inset-0"></div>

            <!-- Modal Box -->
            <div class="relative z-10 bg-white p-6 rounded-lg shadow-lg max-w-sm w-full pointer-events-auto">
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button onclick="confirmLogout()" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Logout</button>
                </div>
            </div>
        </div>
