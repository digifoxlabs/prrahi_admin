    ...
    @endif
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="{{ route('distributor.orders.create') }}"
            ...
            @foreach($orders as $order)
                ...
                <td class="p-3 text-right">
                    <div class="flex items-center justify-end space-x-2">
                        ...
                        @if(auth('distributor')->check() && $order->dispatch_status === 'dispatched')

                              <!-- Deliver Button -->
                                <button type="button" 
                                        onclick="showConfirmation('deliver', '{{ route('distributor.orders.deliver', $order) }}', '{{ $order->order_number }}')"
