            ...
            <div class="mb-4 rounded-xl border border-gray-200 bg-white/90 backdrop-blur
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-3 shrink-0">           
                        ...
                        {{-- Create --}}
                        <a href="{{ route('distributor.retailers.create') }}"
                        ...
                        <tr class="border-t dark:border-gray-700"
                            ...
                            <td class="p-2 relative"
                                ...
                                <div x-cloak x-show="open" x-transition
                                    ...
                                    <a href="{{ route('distributor.retailers.show',$retailer) }}"
                                       class="block px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                                        👁️ View
                                    </a>

                   
                                    <a href="{{ route('distributor.retailers.edit',$retailer) }}"
                                       class="block px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ✏️ Edit
                                    </a>
                                    ...
                                    <button
                                        @click.prevent="showModal=true; deleteUrl='{{ route('distributor.retailers.destroy',$retailer) }}'; open=false"
