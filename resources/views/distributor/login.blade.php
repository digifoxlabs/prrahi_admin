    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="w-full max-w-md pt-10 mx-auto mb-10">
                    <a href="/"
                            ...
                            <form method="POST" action="{{ route('distributor.login.submit') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="login_id" name="login_id" placeholder="info@gmail.com"
...
<!-- Right side panel (Distributor theme) -->
<section class="relative items-center hidden w-full h-full
  ...
  <div class="flex items-center justify-center z-1">
    ...
    <!-- Top shape -->
    <div class="absolute right-0 top-0 -z-1 w-full max-w-[300px] xl:max-w-[500px] opacity-80 pointer-events-none select-none">
      <img src="{{ asset('images/shape/distributor-grid-top.svg') }}" alt="distributor-grid-top" loading="lazy" decoding="async">
    </div>

    <!-- Bottom shape -->
    <div class="absolute bottom-0 left-0 -z-1 w-full max-w-[300px] xl:max-w-[500px] opacity-80 pointer-events-none select-none">
      <img src="{{ asset('images/shape/distributor-grid-bottom.svg') }}" alt="distributor-grid-bottom" loading="lazy" decoding="async">
    </div>

    <!-- Center branding/text -->
    <div class="flex flex-col items-center max-w-xs">
      <a href="#" class="block mb-4">
        <img src="{{ asset('images/logo/auth-logo.svg') }}" alt="Distributor Logo">
      </a>
      <p class="text-center text-white/90 font-semibold">
        Distributor Hub — Coverage • Orders • Logistics
      </p>
    </div>
