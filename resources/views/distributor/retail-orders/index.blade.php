...
<div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <a href="{{ route('distributor.retail.orders.create') }}"
    ...
    <form method="GET" class="mb-4 flex flex-wrap items-center gap-3">
        ...
        <div class="flex-1 min-w-[220px]">
            <input type="text" name="q" value="{{ request('q') }}" placeholder="Search Order Number..."
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('distributor.retail.orders.index') }}" class="px-4 py-2 border rounded-lg text-sm hover:bg-gray-50">
                Clear
            </a>
            @endif
        </div>
                ...
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="p-3 text-right">
                        <div class="flex items-center justify-end space-x-2">
                            <!-- View Button -->
                            <a href="{{ route('distributor.retail.orders.show', $order) }}"
