...
{
    /**
     * List orders created by logged-in sales person
     */
    public function index(Request $request)
    {
        $sales = $request->user();

        $query = \App\Models\Order::with('distributor')
    ...
    public function create(Request $request)
    {
        ...
        $distributors = Distributor::orderBy('firm_name')
            ->where('sales_persons_id', $sales->id)
            ->get();
     ...
     */
    private function validatedData(Request $request, ?\App\Models\Order $order = null): array
    {
